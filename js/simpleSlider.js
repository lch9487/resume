...
(function(window) {
  ...
  var simpleSlider = function simpleSlider(selector, userOptions) {
    ...
    v.pagination = v.container.querySelector(
      "." + v.options.classes.pagination
    );
  ...
  slider.bullets = function(vars) {
    var bullets = vars.pagination.querySelectorAll(
      "." + vars.options.classes.paginationItem
    );
  ...
  slider.moveWrapper = function(vars) {
    ...
    vars.wrapper = vars.container.querySelector(
      "." + vars.options.classes.wrapper
    );
  ...
  slider.setWidth = function(vars) {
    ...
    var slides = vars.container.querySelectorAll(
      "." + vars.options.classes.slide
    );
      ...
      for (property in properties) {
        if (_typeof(properties[property]) === "object") {
          for (propertyDeep in properties[property]) {
            defaults[property][propertyDeep] =
              properties[property][propertyDeep];
          }
        } else {
